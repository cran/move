...
vignette: >
 ...
 %\VignetteIndexEntry{Functions to download data and information from Movebank} 
...
You found a study you are interested in, let's say 'BCI Ocelot'. To get more information about this study, e.g. the authors of the study, license type, citation and more, use:
```{r, eval=F}
